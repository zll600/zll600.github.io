...
const HyphenQueryShortURLEndpoint =
  "https://api.ayaka.io/hyphen/api/v1/url/short";
  ...
  try {
    ...
    return {
      ...
      body: JSON.stringify({
        code: 502,
        message:
          "message" in (err as Error) ? (err as Error).message : String(err),
      }),
    };
  }
};
